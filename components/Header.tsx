    ...
    <header className='sticky-nav'>
      ...
      >
        {(ref) => (
          <div
            ref={ref}
            className='hidden md:block absolute z-10 inset-x-0 transform shadow-lg'
          >
                      ...
                      >
                        <div className='hidden sm:block flex-shrink-0'>
                          <img
                            ...
                            src='https://images.unsplash.com/photo-1558478551-1a378f63328e?ixlib=rb-1.2.1&ixqx=fxyBx7sCT7&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2849&q=80'
                            alt=''
                          />
                        </div>
                    ...
                    <li className='flow-root'>
                      ...
                      >
                        <div className='hidden sm:block flex-shrink-0'>
                          <img
                            className='w-32 h-20 object-cover rounded-md'
                            src='https://images.unsplash.com/1/apple-gear-looking-pretty.jpg?ixlib=rb-1.2.1&ixqx=fxyBx7sCT7&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80'
                            alt=''
                          />
                        </div>
                        <div className='w-0 flex-1 sm:ml-8'>

...
export default function Footer() {
  return (
    <footer className='bg-white' aria-labelledby='footerHeading'>
      ...
      <div className='max-w-3xl lg:max-w-7xl mx-auto px-6 py-6 lg:px-16'>
        <div className='lg:grid lg:grid-cols-3 lg:gap-8'>
          <div className='space-y-8 hidden lg:block lg:col-span-1 pr-16'>
            <div className='h-11 w-9 relative'>
              <Image
                src='/logo/rapid-logo-grayscale.png'
                alt='Rapid logo'
                layout='fill'
                objectFit='contain'
              />
            ...
            <p className='text-gray-500 text-base'>
              Meet somebody new today. Download the app for free to get started.
            </p>
          ...
          <div className='lg:mt-0 lg:col-span-2 grid items-end'>
                        ...
                        <dt className='text-lg'>
                          ...
                          >
                            ...
                            <span className='ml-6 h-7 flex items-center'>
                              {/* <!--
                  Expand/collapse icon, toggle classNames based on question open state.
        ...
        <div className='mt-12 border-t border-gray-200 pt-8 flex gap-x-6 items-center'>
          <div className='relative h-8 w-6 lg:hidden'>
            <Image
              src='/logo/rapid-logo-grayscale.png'
              alt='Rapid Logo'
              layout='fill'
